...
namespace evdekall
{
    public partial class yirmibirvealtmisdortarasi : Form
    {
        public yirmibirvealtmisdortarasi()
        {
            InitializeComponent();
        }

        private void yirmibirvealtmisdortarasi_Load(object sender, EventArgs e)
        {
